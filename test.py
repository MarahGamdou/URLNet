...
with graph.as_default():
    ...
    with sess.as_default():
        ...
        if FLAGS["model.emb_mode"] in [1, 3, 5]:
            input_x_char_seq = graph.get_operation_by_name("input_x_char_seq").outputs[
                0
            ]
        ...
        if FLAGS["model.emb_mode"] in [4, 5]:
            ...
            input_x_char_pad_idx = graph.get_operation_by_name(
                "input_x_char_pad_idx"
            ).outputs[0]
